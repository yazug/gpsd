...
class GPSDictionary(ConfigParser.RawConfigParser):
    ...
    def HTMLDump(self, ofp):
        thead = """
<table border='1' style='font-size:small;background-color:#CCCCCC'>
...
"""
        vhead1 = "<tr><td style='text-align:center;' colspan='7'>" +\
            "<a href='%s'>%s</a></td></tr>\n"
        vhead2 = "<tr><td style='text-align:center;' colspan='7'>" +\
